...
```
wget https://raw.githubusercontent.com/polispay/polis-doc/master/masternode-setup/install_masternode.sh && chmod +x install_masternode.sh && ./install_masternode.sh
```
