...
#https://github.com/polispay/polis/releases/download/v1.2.1/poliscore-1.2.1-linux.zip
tar -xvzf poliscore-1.2.1-linux64.tar.gz
rm poliscore-1.2.1-linux64.tar.gz

# Install polis
echo && echo "Installing poliscore-1.2.1..."
sleep 3
sudo mv ~/poliscore-1.2.1/usr/local/bin/polis{d,-cli} /usr/local/bin
